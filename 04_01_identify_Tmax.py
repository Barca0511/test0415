...
file_2023 = r"2023/ERA5Land_2023_tmax_anomaly_0525_0907_by_diming.csv"
file_threshold = r"2023/threshold/ERA5Land_1981_2010_tmax_anomaly_threshold_p90_0601_0831_by_diming.csv"
...
df = df.merge(
    df_threshold[["region_name", "month_day", "temp_max_anomaly_threshold"]],
...
cond = mask & (df["temp_max_anomaly"] > df["temp_max_anomaly_threshold"])

df.loc[cond, "day"] = 1
df.loc[cond, "day_intensity"] = df.loc[cond, "temp_max_anomaly"] - df.loc[cond, "temp_max_anomaly_threshold"]
