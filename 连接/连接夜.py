...
file2 = r"ERA5Land_2023_tmin_anomaly_0525_0907_by_diming.csv"
...
if missing_cols:
    raise ValueError(f"ERA5Land_2023_tmin_anomaly_0525_0907_by_diming.csv 缺少这些字段: {missing_cols}")
